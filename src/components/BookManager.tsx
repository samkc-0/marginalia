...
export function BookManager(): JSX.Element {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <h2 className="mt-10 text-lg dark: text-gray-300 font-bold cursor-default mb-2">
        ──── {LBL_SAVED_BOOKS} ────
      </h2>
      <ul>
        {savedBooks.length ? (
            ...
            >
              ...
              <button
                ...
                onClick={(e) => {
                  ...
                  if (!book.id) throw new Error(`Book ${book.name} has no id.`)
